...
srun python $HOME/experiments/Multi_Agent_LE_Torch/scripts.py --experiment baseline_population_training --num_senders 2 --num_receivers 2 --finetuning_epochs 50 --save_every 1 --run_key $1
